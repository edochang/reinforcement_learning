...
class Policy_DeterministicGreedy(Policy):
    ...
    def action(self, state: int) -> int:
        ...
        # Assume the value of Q[state,action] gives the value of the action
        # Return the action that gives the max action value for the given state
